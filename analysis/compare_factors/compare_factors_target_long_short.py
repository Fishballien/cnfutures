...
if __name__ == "__main__":
    ...
    compare_name = "till20_nsr22_filter_by_hhi_pos"
    factor_info_list_dict = [
        ...
        {
            "tag_name": "zxt",
            "process_name": "till20_nsr22_orderflow_metrics_v0_self",
            "factor_name": "alpha_x_hhi_pos_filter_0.1",
        ...
        },
        {
            "tag_name": "zxt",
            "process_name": "till20_nsr22_orderflow_metrics_v0_self",
            "factor_name": "alpha_x_hhi_pos_filter_0.2",
            "test_name": "icim_intraday_scale_around_op05cl0"
            # 没有custom_path，使用标准路径
        },
        {
            "tag_name": "zxt",
            "process_name": "till20_nsr22_orderflow_metrics_v0_self",
            "factor_name": "alpha_x_hhi_pos_filter_0.3",
            "test_name": "icim_intraday_scale_around_op05cl0"
            # 没有custom_path，使用标准路径
        },
        {
            "tag_name": "zxt",
            "process_name": "till20_nsr22_orderflow_metrics_v0_self",
            "factor_name": "alpha_x_hhi_pos_filter_0.4",
            "test_name": "icim_intraday_scale_around_op05cl0"
            # 没有custom_path，使用标准路径
        },
        {
            "tag_name": "zxt",
            "process_name": "till20_nsr22_orderflow_metrics_v0_self",
            "factor_name": "alpha_x_hhi_pos_filter_0.5",
            "test_name": "icim_intraday_scale_around_op05cl0"
            # 没有custom_path，使用标准路径
        },
