...
def apply_trade_rules(factor_scaled, trade_rule_name, trade_rule_param):
    """Apply trade rules to the scaled factor"""
    logger.info(f"Applying trade rule: {trade_rule_name}")
...
if __name__ == "__main__":
    ...
    base_config = {
        ...
        'feature_dir': Path(r'D:/mnt/idx_opt_processed/v0_features'),
        ...
        'fee': 0.00024,
        'save_dir': Path(r'D:/mnt/CNIndexFutures/timeseries/factor_test/results/analysis/trades')
    }
