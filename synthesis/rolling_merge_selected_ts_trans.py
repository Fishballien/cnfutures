...
from synthesis.merge_selected_ts_trans import FactorMerger

                
# %%
def run_rolling_merge_selected_ts_trans(merge_name, rolling_merge_name, pstart='20230701', puntil=None, 
    ...
    param_dir = Path(path_config['param']) / 'rolling_merge_selected_ts_trans'
