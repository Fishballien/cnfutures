...
def run_rolling_trade_select(select_name, rolling_select_name, pstart='20180101', puntil=None, 
                             mode='rolling', merge_type=None, merge_name=None):
    """
    ...
    merge_type : str, optional
        Type of evaluation to merge, if None will use value from configuration file
    merge_name : str, optional
        Name of evaluation to merge, if None will use value from configuration file
